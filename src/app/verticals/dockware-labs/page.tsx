        ...
        <>
                ...
                <Container>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        <div className="space-y-6">
                            <p className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 font-mono">What We Do</p>
            ...
            <section className="py-20">
                <Container>
                    <div className="max-w-2xl mx-auto text-center">
                        <p className="text-xs font-bold uppercase tracking-[0.2em] text-blue-600 font-mono mb-3">What We Use</p>
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            {["React / Next.js", "Node.js", "Python", "AWS / Azure", "PostgreSQL", "Redis", "Docker", "Kubernetes", "REST & GraphQL", "CI/CD Pipelines"].map((tech) => (
                                <span key={tech} className="px-4 py-2 rounded-sm bg-secondary border border-border/60 text-sm font-medium text-foreground font-mono">
                                    {tech}
                                </span>
                            ))}
                        </div>
            ...
            <section className="py-20 bg-foreground text-background relative overflow-hidden">
                ...
                <Container className="relative z-10 text-center">
                    ...
                    <Button className="rounded-sm px-10 h-14 text-base font-semibold bg-blue-600 text-white hover:bg-blue-600 shadow-lg hover:shadow-blue-600/25 transition-all duration-300" asChild>
