        ...
        <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                <Button className="rounded-sm px-8 font-semibold bg-foreground text-background hover:bg-foreground/90" asChild>
                                    <Link href="/verticals">Explore Our Verticals <ArrowRight className="ml-2 w-4 h-4" /></Link>
                                </Button>
                                <Button variant="outline" className="rounded-sm px-8 font-semibold border-border/60" asChild>
                                ...
                                {milestones.map((m, i) => (
                                    <div key={i} className="flex gap-6 group">
                                        <div className="flex flex-col items-center shrink-0">
                                            <div className="w-14 h-14 rounded bg-foreground text-background flex items-center justify-center font-display font-bold text-sm z-10 group-hover:bg-brand group-hover:text-brand-foreground transition-colors duration-300">
                                                {m.year.slice(2)}
                                            </div>
                                        </div>
                                        <div className="flex-1 pb-6">
                                            <div className="p-6 bg-card rounded border border-border/50 group-hover:border-border group-hover:shadow-md transition-all duration-300">
            ...
            <section className="py-20 bg-foreground text-background relative overflow-hidden">
                ...
                <Container className="relative z-10 text-center">
                    ...
                    <Button className="rounded-sm px-10 h-14 text-base font-semibold bg-brand text-brand-foreground hover:bg-brand/90 shadow-lg hover:shadow-xl transition-all duration-300" asChild>
