            ...
            <Container className="max-w-4xl">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                    <p className="lead text-xl text-foreground/80">
                        These Terms of Service ("Terms") govern your use of the website operated by Dockfinity Private Limited ("Dockfinity") and the services provided by its verticals: Dockware Labs, Trading Dock, and Impression Dock.
                    </p>
                    ...
                    <h3 className="text-xl font-bold mt-6 mb-3">Impression Dock</h3>
                    <p>
